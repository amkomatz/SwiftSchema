...
final class RoundTests: SwiftSchemaTest {
    ...
    func test_decode_requiredFloat_fractionInJson_roundDown_isCorrect() throws {
    ...
    func test_decode_requiredFloat_fractionInJson_roundUp_isCorrect() throws {
    ...
    func test_decode_requiredDouble_fractionInJson_roundDown_isCorrect() throws {
        let json = #"{"field_1":1.2}"#
    ...
    func test_decode_requiredDouble_fractionInJson_roundUp_isCorrect() throws {
        let json = #"{"field_1":1.5}"#
